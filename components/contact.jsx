...
export default function contact() {
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 -mt-4">Please Contact me directly at  {" "}<a className="underline" href="mailto:pradhanswastika840@gmail.com"> pradhanswastika840@gmail.com</a> {" "} on through this form.</p>
